# 長照、身心障礙與社福 Elder Care, Disability & Social Welfare

## Reference Fit

Use this file when the user need involves:
- Long-term care, disability certificate, assistive devices, accessible transport, elder welfare, dementia, caregiver stress/support.
- Social welfare: rent/social-housing subsidy, low income, homeless shelter, social welfare consultation, caregiver support.
- Accessibility: sign language, disability parking, accessibility complaint, foreign/domestic caregiver issues.
...
- The question is primarily medical diagnosis/treatment, school/special education, labor rights, or housing contract dispute.

Adjacent references:
- `references/nhi-healthcare.md` for hospital/clinic, NHI, medical records, medication, or public-health care route.
- `references/education-childcare-family.md` for child special education, daycare, school support, or education bureau route.
- `references/work-labor-rights.md` for foreign caregiver labor rights, employer dispute, or 1955 route.

Fast disambiguators:
- Ask age, city/district, household/ARC/NHI status, disability certificate/long-term-care status, urgency, and living arrangement.
- Ask whether the need is service eligibility, subsidy, care crisis, accessibility complaint, or caregiver/employer dispute.
