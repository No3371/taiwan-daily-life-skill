# 緊急狀況 Emergency & Safety

## Reference Fit

Use this file when the user need involves:
- Immediate safety routing: police 110, fire/ambulance 119, mobile 112, DV/child/sexual assault 113, fraud 165, self-harm crisis 1925, migrant-worker urgent support 1955.
- Emergency-adjacent support numbers: 1990, 1922, 1966, 1957, 1950, 1919, pregnancy, addiction, caregiver support.
- Rapid first-action sequencing before domain detail: danger, abuse, scam transfer, missing person, medical crisis, disaster danger.

Do not use this file as the main route when:
- The user's immediate danger is already handled and the remaining question is a routine domain-specific admin process.
- A nonurgent issue is better owned by healthcare, legal, labor, weather, transportation, housing, or banking after triage.

Adjacent references:
- `references/legal-process-mediation.md` for police report follow-up, protection orders, legal aid, court, stalking/harassment.
- `references/nhi-healthcare.md` for nonemergency clinic/hospital, NHI, mental-health care, addiction support after immediate safety.
- `references/weather-earthquakes-holidays-closures.md` and `references/civil-defense-alerts-wartime.md` for official current status once safety actions are clear.

Fast disambiguators:
- Ask first whether there is immediate danger, injury, fire, violence, self-harm risk, active scam transfer, or inability to stay safe.
- Ask location only after giving the right immediate number/action unless dispatch/local service depends on it.
