# 住房、公用事業與鄰里 Housing, Utilities & Neighborhood

## Reference Fit

Use this file when the user need involves:
- Rentals, lease, landlord/deposit dispute, rent subsidy/lease records, property transcript, sublet/short-term rental concerns.
- Utilities and home operations: electricity, water, gas, internet comparison, garbage/recycling/bulky waste, neighborhood nuisance.
- Local building/property routing: leaks, mold, pests, building committee, illegal construction, potholes, road lights, local 1999.
...
- The issue is mainly ARC/household address registration, consumer-purchase dispute, or welfare/rent subsidy eligibility.

Adjacent references:
- `references/government-identity.md` for ARC address change, household registration, and official address records.
- `references/mail-parcels-consumer-life.md` for parcel, marketplace, delivery, or consumer-product disputes.
- `references/elder-care-disability-social-welfare.md` for rent/social-housing subsidy, low-income, or disability housing support.

Fast disambiguators:
- Ask city/district and whether the user is renter, owner, subtenant, or building manager.
- Ask whether there is danger now: gas smell, fire, flooding, electrical hazard, violence, or unsafe building condition.
