# 法律流程與調解 Legal Process & Mediation

## Reference Fit

Use this file when the user need involves:
- Legal aid, mediation, police report, criminal complaint, cybercrime, missing person, stalking/harassment, protection order.
- Court/process routing: small claim, civil dispute, administrative appeal cues, POA/will/notarization where legal forum matters.
- Sexual harassment route selection outside purely workplace/school channels.
...
- The question is primarily landlord/consumer/labor dispute before legal escalation, or identity-document notarization only.

Adjacent references:
- `references/emergency-safety.md` for danger, DV/sexual assault, immediate police/fire/ambulance, fraud crisis, or self-harm risk.
- `references/housing-utilities-neighborhood.md` for landlord/deposit/building disputes before legal escalation.
- `references/work-labor-rights.md` for workplace harassment, unpaid wages, termination, labor bureau, or labor mediation.

Fast disambiguators:
- Ask whether anyone is in danger now, whether a police report/court notice exists, and any deadline or case number.
- Ask dispute setting: family, landlord, workplace, consumer, school, online, traffic, or government agency.
