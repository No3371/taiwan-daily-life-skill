...
- Income tax, 183-day residency, withholding, tax ID/unified ID, deductions, eTax, alien income-tax filing, tax certificates.
- Business/VAT, local property/land/vehicle taxes, fuel fee, tax payment routes, e-invoice lottery/carrier.
- Questions where current filing year, residence days, or income category changes the official route.
...
- The issue is primarily identity-document setup, bank account/payment mechanics, or property ownership verification.

Adjacent references:
- `references/government-identity.md` for ARC/APRC, unified ID, MyData, or natural-person-certificate login blockers.
- `references/banking-fraud-insurance.md` for bank remittance, card, account, insurance, or fraud issues around payment.
- `references/housing-utilities-neighborhood.md` for land/building transcript or rental-property ownership checks.

Fast disambiguators:
- Ask tax year, days in Taiwan that year, income type, employer withholding status, and whether the user has ARC/APRC/Taiwan ID.
- Ask whether the tax is national income tax, local property/vehicle tax, business tax, fuel fee, or e-invoice.
